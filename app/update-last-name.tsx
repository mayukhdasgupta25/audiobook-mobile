...
/**
 * Update last name screen
 * Allows user to update their last name
 */
export default function UpdateLastNameScreen() {
   ...
   const handleUpdate = useCallback(async () => {
      ...
      try {
         ...
         try {
            ...
            console.error('[UpdateLastName] Failed to refresh user profile:', profileError);
         }
         ...
         if (err instanceof ApiError) {
            if (err.status === 400) {
               ...
               setError(errorData?.message || 'Invalid last name. Please try again.');
            ...
            console.error('[UpdateLastName] Non-API error:', errorMessage);
   ...
   }, [lastName, currentLastName, dispatch]);
            ...
            >
               ...
               >
                  ...
                  <View style={styles.header}>
                     ...
                     <Text style={styles.title}>Update Last Name</Text>
